...
$("#btnSiguienteDirectores").click(function () {
  ...
  } else if ($("#regRet").val() == 2023) {
    primerTramoHasta = 14301209.21;
    segundoTramoDesde = 14301209.21;
    segundoTramoHasta = 143012092.08;
    segundoTramoFijo = 3575302.3;
    segundoTramoExcedente = 14301209.21;
    tercerTramoDesde = 143012092.08;
    tercerTramoFijo = 42188567.16;
    tercerTamoExcedente = 143012092.08;
  } else if ($("#regRet").val() == 2024) {
    primerTramoHasta = 34703523.08;
    segundoTramoDesde = 34703523.08;
    segundoTramoHasta = 347035230.79;
    segundoTramoFijo = 8675880.77;
    segundoTramoExcedente = 34703523.08;
    tercerTramoDesde = 347035230.79;
    tercerTramoFijo = 102375393.08;
    tercerTamoExcedente = 347035230.79;
  } else if ($("#regRet").val() == 2025) {
    primerTramoHasta = 101679575.26;
    segundoTramoDesde = 101679575.26;
    segundoTramoHasta = 1016795752.62;
    segundoTramoFijo = 25419893.82;
    segundoTramoExcedente = 101679575.26;
    tercerTramoDesde = 1016795752.62;
    tercerTramoFijo = 299954747.02;
    tercerTamoExcedente = 101679575.26;
  } else if ($("#regRet").val() == 2026) {
    primerTramoHasta = 133514185.74;
    segundoTramoDesde = 133514185.74;
    segundoTramoHasta = 1335141857.38;
    segundoTramoFijo = 33378546.43;
    segundoTramoExcedente = 1335141857.38;
    tercerTramoDesde = 1335141857.38;
    tercerTramoFijo = 393866847.93;
    tercerTamoExcedente = 1335141857.38;
  }
  ...
  let totalTope2Val = function () {
      ...
      if ($("#resultadoPositivo").prop("checked") == true) {
        ...
        `;
            ...
            if (totalTope2HtmlIIGG < 0) {
              ...
              htmlTopeDos += `
        <img src="bimages/tercerTramo2022.webp" class="ms-3 img-fluid" alt="Tercer tramo">
        `;
              datosTope2.innerHTML = htmlTopeDos;
    ...
    if ($("#regRet").val() == 2023) {
      $("#periodoFiscalDato").text(
        "Estás calculando para el período fiscal 2023"
      );
        ...
        if ($("#IIGGdiferido").prop("checked") == true) {
          ...
          `;
            ...
            if (totalTope2HtmlIIGG < 0) {
              ...
              htmlTopeDos += `
          <img src="bimages/tercerTramo2023.webp" class="ms-3 img-fluid" alt="Tercer tramo">
          `;
              datosTope2.innerHTML = htmlTopeDos;
    ...
    } // FINAL PERÍODO FISCAL 2023

    // PERÍODO FISCAL 2024
    if ($("#regRet").val() == 2024) {
      $("#periodoFiscalDato").text(
        "Estás calculando para el período fiscal 2024"
      );
        ...
        if ($("#IIGGdiferido").prop("checked") == true) {
          if (UiHonoTopeDos <= primerTramoHasta) {
            ...
            if (totalTope2HtmlIIGG < 0) {
              ...
              htmlTopeDos += `
              <img src="bimages/tercerTramo2024.webp" class="ms-3 img-fluid" alt="Tercer tramo">
              `;
              datosTope2.innerHTML = htmlTopeDos;
    ...
    } // FINAL PERÍODO FISCAL 2024

    // PERÍODO FISCAL 2025
    if ($("#regRet").val() == 2025) {
      $("#periodoFiscalDato").text(
        "Estás calculando para el período fiscal 2025"
      );
        ...
        if ($("#IIGGdiferido").prop("checked") == true) {
          if (UiHonoTopeDos <= primerTramoHasta) {
            ...
            if (totalTope2HtmlIIGG < 0) {
              ...
              htmlTopeDos += `
              <img src="bimages/primerTramo2025.webp" class="ms-3 img-fluid" alt="Primer tramo">
              `;
              datosTope2.innerHTML = htmlTopeDos;
            ...
            if (totalTope2HtmlIIGG < 0) {
              ...
              htmlTopeDos += `
              <img src="bimages/segundoTramo2025.webp" class="ms-3 img-fluid" alt="Segundo tramo">
              `;
              datosTope2.innerHTML = htmlTopeDos;
            ...
            if (totalTope2HtmlIIGG < 0) {
              ...
              htmlTopeDos += `
              <img src="bimages/tercerTramo2025.webp" class="ms-3 img-fluid" alt="Tercer tramo">
              `;
              datosTope2.innerHTML = htmlTopeDos;
    ...
    } // FINAL PERÍODO FISCAL 2025

    // PERÍODO FISCAL 2026
    if ($("#regRet").val() == 2026) {
      $("#periodoFiscalDato").text(
        "Estás calculando para el período fiscal 2026"
      );
        ...
        if ($("#IIGGdiferido").prop("checked") == true) {
          if (UiHonoTopeDos <= primerTramoHasta) {
            ...
            if (totalTope2HtmlIIGG < 0) {
              ...
              htmlTopeDos += `
              <img src="bimages/primerTramo2026.webp" class="ms-3 img-fluid" alt="Primer tramo">
              `;
              datosTope2.innerHTML = htmlTopeDos;
            ...
            if (totalTope2HtmlIIGG < 0) {
              ...
              htmlTopeDos += `
              <img src="bimages/segundoTramo2026.webp" class="ms-3 img-fluid" alt="Segundo tramo">
              `;
              datosTope2.innerHTML = htmlTopeDos;
            ...
            if (totalTope2HtmlIIGG < 0) {
              ...
              htmlTopeDos += `
              <img src="bimages/tercerTramo2026.webp" class="ms-3 img-fluid" alt="Tercer tramo">
              `;
              datosTope2.innerHTML = htmlTopeDos;
  ...
  `;
    ...
    `;
      ...
      let noComputableRete = Intl.NumberFormat("es", {
        ...
        .format(
          +excedentePerceptoresReteEval * (+directorReteEval / +aprobadoTotal)
        )
        .replace("US$", "");
      let noComputableReteEval = noComputableRete
        .replace(/\./g, "")
...
function maskApply() {
  $(document).ready(function () {
    $(".directoresPluralidad").mask("000.000.000.000.000,00", {
      reverse: true,
    });
